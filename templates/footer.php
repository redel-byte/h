        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex items-center space-x-6">
                    <a href="/privacy.php" class="text-sm text-gray-600 hover:text-gray-900">Confidentialité</a>
                    <a href="/terms.php" class="text-sm text-gray-600 hover:text-gray-900">Conditions</a>
                    <a href="/contact.php" class="text-sm text-gray-600 hover:text-gray-900">Contact</a>
