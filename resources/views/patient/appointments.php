...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-3">
            <a href="<?php echo defined('BASE_PATH') ? constant('BASE_PATH') : ''; ?>/patient/book-appointment.php" class="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700">Prendre RDV</a>
                    ...
                    <?php else: ?>
                        <?php foreach (($appointments ?? []) as $a): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700"><?php echo htmlspecialchars((string)($a['doctor_id'] ?? '')); ?></td>
