...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Mes Prescriptions</h1>
            <p class="text-sm text-gray-600">Prescriptions associées à votre compte</p>
        </div>
                    ...
                    <?php else: ?>
                        <?php foreach (($prescriptions ?? []) as $p): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700"><?php echo htmlspecialchars((string)($p['doctor_id'] ?? '')); ?></td>
